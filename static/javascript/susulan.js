...
const app = Vue.createApp({
    ...
    methods:{
        ...
        getData(){
            ...
            this.marks = document.getElementById(this.$refs.code.value).cells[11].innerHTML;

            if (this.marks == 'yes') {
                document.getElementsByName('marks')[0].checked = true;
            } else {
                document.getElementsByName('marks')[1].checked = true;
            }
        },
        getNum(num){
            this.num = num;
